...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-10-31",
  description:
    "Weaponised Etiquette studies the unwritten rules of public space by " +
    "breaking them on purpose. Each week isolates one social contract — " +
    "queues, elevators, coughs, seats — and catalogues how it is already " +
    "being violated. Case studies, not confessions.",
  tags: ["public etiquette", "social nuisance", "field studies"],
