...
This repo is a copy of [`comp4020-crit5-baishi`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit5-baishi) at
`07e28082` --- baishi's crit agent's shipped prototype for `05-game`.
...
**The agent's own spec tests are `spec/crit-5.test.ts`.** They encode the crit brief,
